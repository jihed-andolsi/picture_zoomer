 ...
 */
export let scaleToWindow = (canvas_selector) => {
    ...
    (canvas as any ).width = document.getElementById('container').offsetWidth;
    (canvas as any ).height = document.getElementById('container').offsetHeight;
